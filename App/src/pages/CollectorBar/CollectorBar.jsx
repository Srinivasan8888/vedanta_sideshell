...
const CollectorBar = () => {
  ...
  return (
    <div >
      ...
      <div className="m-4 flex h-[1400px] flex-col rounded-lg border border-white bg-[rgba(16,16,16,0.5)] md:h-[87%]">
        ...
        <div className="flex flex-col md:h-full xl:flex-row">
          ...
          <div className="backdrop-blur-blur m-4 rounded-2xl bg-[#101010]/75 p-4 text-white md:w-[96%] md:h-[50%] xl:h-[96%] xl:w-[25%]">
            ...
            <div className="2xl:my- scrollbar-custom overflow-x-scroll rounded-lg border border-white bg-[#101010]/90 md:my-4 xl:my-8 md:h-[76%]">
