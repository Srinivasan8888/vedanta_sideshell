...
const AverageDateRange = () => {
  ...
  return (
    <>
      ...
      <div className="mt-4 flex flex-row items-center justify-center font-['Poppins'] text-[12px] font-semibold md:mt-0 md:h-[10%] xl:text-[10px] 2xl:text-[15px] 2xl:font-bold">
      ...
      <div className="w-[80%] grid-cols-1 grid-rows-5 justify-center gap-4 md:grid md:h-[70%] 2xl:w-[60%] 2xl:gap-0">
        ...
        <div className="flex flex-col items-center justify-between md:flex-row">
          <div className="ttext-[12px] text-start font-normal xl:text-[10px] 2xl:text-[15px]">
            From
          </div>
          <div>
            <input
              ...
              onChange={handleDateChange}
              value={startDate}
              className="custom-datepicker mt-4 h-9 w-64 rounded-lg border border-white/30 bg-transparent p-1 text-sm text-white shadow-[inset_4px_4px_4px_0_rgba(0,0,0,0.25)] backdrop-blur-[8px] md:mt-0"
              style={{
                colorScheme: "dark",
        ...
        <div className="flex flex-col items-center justify-between">
          ...
          <div className="flex flex-col items-center justify-between gap-10 md:flex-row">
            ...
            <div className="mb-3 flex items-center 2xl:mb-10">
              ...
              <label
                htmlFor="radio-3"
                className="2xl:text-[15px]font-medium ms-2 text-[12px] text-gray-900 xl:text-[10px] dark:text-gray-300"
              >
                Day
              </label>
            </div>
