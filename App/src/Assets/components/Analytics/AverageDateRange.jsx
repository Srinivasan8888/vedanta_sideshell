...
<div className="h-[15%] text-center text-[12px] xl:text-[10px] 2xl:text-[15px] font-normal flex items-center justify-center">Select Date Range</div>
...
<div className="flex flex-col md:flex-row items-center justify-center gap-4">
  ...
  <div className="flex flex-col md:flex-row items-center justify-center md:space-x-14 ">
    ...
    <div className="flex items-center ">
      ...
      <label
        htmlFor="radio-2"
        className="text-[12px] xl:text-[8px] 2xl:text-[15px] font-normal font-medium text-gray-900 ms-2 dark:text-gray-300"
      >
        hour
      </label>
    </div>
...
<div className="flex items-center justify-center mb-4 h-[20%]">
  <button className=" h-[80%]  md:w-[25%]  md:h-[100%] xl:w-[30%] bg-[#e9eefb]/50 rounded-lg border-2 border-white text-[12px]   md:text-[12px] xl:text-[8px] 2xl:text-[15px] font-normal" onClick={fetchdatagraph}>
    Plot Graph
  </button>
</div>
