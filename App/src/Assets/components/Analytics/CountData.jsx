...
const CountData = ({ selectedBusBar, setFetchedData }) => {
  ...
  return (
    ...
    <div className="border xl:w-[25%] w-[100%] h-[300px] xl:h-[100%] flex flex-col gap-2 rounded-xl  bg-gradient-to-br from-white/20 via-white/5 to-white/20 backdrop-blur-[5px]">
      ...
      <div className="h-[65%] flex flex-col items-center justify-center gap-8">
            ...
            {showTextBox && (
              <div className="flex flex-row items-center justify-center">
                <input
                  type="number"
                  placeholder="Enter custom data"
                  className="p-2 text-black border rounded-md text-[10px] md:text-[12px] xl:text-[6px] 2xl:text-[15px] font-normal"
                  onChange={(e) => setCustomLimit(e.target.value)}
                />
              </div>
            )}
